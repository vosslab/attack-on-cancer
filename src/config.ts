...
export const TOWERS: Record<TowerId, TowerConfig> = {
  doctor: {
    ...
    damage: 13,
    cooldown: 0.68,
    attackVisualDurationByTier: [0.22, 0.28, 0.34, 0.42],
    color: "#3178c6",
  ...
  chemotherapy: {
    ...
    cooldown: 1.12,
    splashRadius: 48,
    splashRadiusByTier: [48, 58, 72, 90],
    attackVisualDurationByTier: [0.28, 0.36, 0.46, 0.58],
    color: "#9b45c6",
  ...
  t_cell: {
    ...
    damage: 10,
    cooldown: 0.29,
    attackVisualDurationByTier: [0.18, 0.22, 0.28, 0.34],
    color: "#e5534b",
  ...
  radiation: {
    ...
    damage: 62,
    cooldown: 1.7,
    attackVisualDurationByTier: [0.3, 0.4, 0.52, 0.68],
    color: "#ec9c27",
  ...
  antibody: {
    ...
    slowFactor: 0.76,
    color: "#18a890",
    attackVisualDurationByTier: [0.2, 0.26, 0.34, 0.44],
  ...
  macrophage: {
    ...
    attackVisualDurationByTier: [0.3, 0.4, 0.52, 0.66],
    color: "#287f85",
    description:
